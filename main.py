...
def start_training(character):
    ...
    cmd = None
    commands_training: dict[str, any] = {
    ...
    while cmd != 'skip':
        ...
        if cmd in commands_training:
            print(commands_training[cmd]())
...
if __name__ == "__main__":
    ...
    character_selection = choice_char_class("Владимир")
    workout = start_training(character_selection)